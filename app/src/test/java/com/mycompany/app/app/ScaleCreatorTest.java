...
public class ScaleCreatorTest {
	...
	public void testScaleEightCreationEasy() {
		...
		Note[] DoMajorScale = { new Note("DO"), new Note("RE"), new Note("MI"), new Note("FA"), new Note("SOL"),
				new Note("LA"), new Note("SI"), new Note("DO") };
		List<Note> majorScaleOfDO = scaleCreator.createScale(rootNoteDO, majorScale);
	...
	public void testScaleEightCreationLessTrivial() {
		...
		List<Note> minorScaleOfDO = scaleCreator.createScale(rootNoteDO,minorScale);
		...
		List<Note> majorScaleOfFaDiesis = scaleCreator.createScale(rootNoteFaDiesis,majorScale);
	...
	public void testScaleEightCreationStartingWithB() {
		...
		List<Note> majorScaleOfLAb = scaleCreator.createScale(rootNoteLAb,majorScale);
		...
		List<Note> minorScaleOfLAb = scaleCreator.createScale(rootNoteLAb,minorScale);
	...
	public void testScaleEightCreationWithRootNoteChange() {
		...
		List<Note> locrianScaleOfFAb = scaleCreator.createScale(rootNoteFAb,locrianScale);
	...
	public void testScaleEightCreationWithRootNoteChangeInTheMiddle() {
		...
		Note[] SOLdiesisMajorScale = {new Note("LAb"), new Note("SIb"), new Note("DO"), 
				new Note("REb"), new Note("MIb"), new Note("FA"), new Note("SOL"), new Note("LAb")};
		List<Note> majorScaleOfSOLdiesis = scaleCreator.createScale(rootNoteSOLdiesis,majorScale);
	...
	public void testScaleEightCreationFor100Coverage() {
		...
		List<Note> locrianScaleOfSOLb = scaleCreator.createScale(rootNoteSOLb,locrianScale);
		...
		List<Note> locrianScaleOfSIb = scaleCreator.createScale(rootNoteSIb,locrianScale);
		...
		List<Note> locrianScaleOfDOb = scaleCreator.createScale(rootNoteDOb,locrianScale);
		...
		List<Note> dorianScaleOfREb = scaleCreator.createScale(rootNoteREb,dorianScale);
		...
		List<Note> dorianScaleOfMib = scaleCreator.createScale(rootNoteMIb,dorianScale);
